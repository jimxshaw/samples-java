...
public class Program1 extends JFrame {
    ...
    class GuiPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            GradientPaint gp = new GradientPaint(0, 0, Color.white, 0, getHeight(), new Color(175, 255, 175));
            g2d.setPaint(gp);
    ...
    public Program1() {
        ...
        jmi.addActionListener(e -> {
            String input = JOptionPane.showInputDialog(Program1.this, "Enter 1 or more salary employees");
            if (input != null) {
                list.getData(input);
                repaint();
            }
        ...
        jm.addSeparator();
        jmi.addActionListener(e -> {
            String input = JOptionPane.showInputDialog("Enter additional salary employees");
            if (input != null) {
        ...
        jmi.addActionListener(e -> JOptionPane.showMessageDialog(Program1.this,
