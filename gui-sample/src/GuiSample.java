...
public class GuiSample extends JFrame {
	...
	class StudentPanel extends JPanel {
		...
		public void paintComponent(Graphics g) {
			...
			GradientPaint gp = new java.awt.GradientPaint(0, 0, Color.white,
					getWidth(), getHeight(), new Color(75, 255, 75));
			g2d.setPaint(gp);
			...
			for (int i = 0; i < list.length(); i++) {
				...
				int highest = list.getHighest();
				int lowest = list.getLowest();
				float average = list.getAverage();

				g.drawString("Highest: " + highest, 500, 100);
				g.drawString("Lowest: " + lowest, 500, 200);
				g.drawString("Average: " + average, 500, 300);
			}
		}
	}
	...
	public GuiSample() {
		...
		jmi.addActionListener(e -> {
			String input = JOptionPane
					.showInputDialog("Enter 1 or more students");
			if (input != null) {
				list.getData(input);
				repaint();
			}
		...
		jmi.addActionListener(e -> JOptionPane.showMessageDialog(
				GuiSample.this, new JLabel("<html><big><center>"
